...
| 004 real Codex E2E, security/operations hardening | 20% | 15% | Prior workspace-write/native-helper diagnostics remain historical and are not governed acceptance evidence. The 004-s launcher records Codex 0.149.0 global-yolo argv facts, and the exact two-invocation run proved dependency bytes, observation, compilation, injection, sentinel, persistent cache reuse, compiler suppression, and protected-state post-audit without changing the protected service. The strategic percentage remains unchanged here pending strategic acceptance; remaining gaps are listed separately | Actual forced/equivalent long-session compaction, vision-capable E2E, broader security/observability hardening review, and systemd candidate proof |
