...
| 004 real Codex E2E, security/operations hardening | 20% | 15% | Prior diagnostic elaboration is not governed E2E evidence. The historical raw probe remains narrowly `raw_bwrap_unshare_all_loopback_bootstrap_failed`; the OAP parent was independently established as host-direct/unsandboxed. Immutable 004-o records the startup placement failure. Corrected 004-p B reached Codex 0.149.0 and exited 0 with one successful ordinary command; 004-q removes the over-strict literal-command gate and started one fresh workspace-write A invocation, but its sanitized result was not retrievable from this execution. Dependency bytes, adapter/compiler/model calls, and governed/cache E2E therefore remain unproven. No Local Coding defect was tested and no protected service was changed | Ordinary B+A lifecycle evidence, exact dependency bytes, governance-derived sentinel success, successful ordinary-read lifecycle and cache reuse, actual forced/equivalent long-session compaction, vision-capable E2E, security hardening review, and systemd candidate proof |
