...
Current authoritative recovery-branch readiness: ~68%.
...
| 003 selection, injection, acquisition, rehydration | 25% | 75% | PR #4 plus recovery PR; one-root pipeline/cache tests; fake-upstream dependency acquisition/isolation/failure tests | Compaction rehydration |
...
| **Weighted total** | **100%** | **~68% on branch** | OAP orders/reports/CI | See rows above |
